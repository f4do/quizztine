...
export default function AudioRecorder({ onUploaded, onError }: AudioRecorderProps) {
    ...
    <div className="space-y-2">
      ...
      {isRecording && (
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm text-gray-700 dark:text-gray-300">Recording {(durationMs / 1000).toFixed(1)}s / 10s</span>
          <button
            type="button"
